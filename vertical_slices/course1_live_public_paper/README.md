...
D22-B remains blocked and unimplemented. **ADR-024** records the definitive
Netcup Ubuntu VPS PAPER runtime profile; capture and deployment starts remain
separately authorized CoS scope. Schema v3 and Phase 1A-3B1C-2+ stay dormant.
No additional DATA-1 venue
is added here.
